...
urlpatterns = [
    ...
    path("results/view/", hod_views.admin_view_results,
    ...
    path("branch/delete/<int:branch_id>",
         hod_views.delete_branch, name='delete_branch'),
    ...
    path("branch/edit/<int:branch_id>",
         hod_views.edit_branch, name='edit_branch'),
    path("subject/edit/<int:subject_id>",
         hod_views.edit_subject, name='edit_subject'),
     #realtime filtering of subjects in takeattendance
     path('get_filtered_subjects/<int:branch_id>/', 
          hod_views.get_filtered_subjects, name='get_filtered_subjects'),
    ...
    path("staff/fetch_results/",staff_views.fetch_results,name='fetch_results'),
    ...
    path("staff/attendance/report/",
         staff_views.staff_attendance_report, name='staff_attendance_report'),
    ...
    path('staff/result/report/',
         staff_views.staff_marks_report, name='staff_marks_report'),
     path('staff/result/midterms/',
         staff_views.staff_midterm_report, name='staff_midterm_report'),
